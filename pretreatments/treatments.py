...
def getDensityByCountry():
    liste_cluster, df_service = voisinage.get_service_country_list(4500)
    for value in liste_cluster:
        ...
        all_matrix = get_slots_matrix(0, list_service_same)
        all_matrix = get_slots_matrix(1, list_service_same)
        
        print(value,'\t:', total_ser)
